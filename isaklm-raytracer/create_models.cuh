...
std::vector<Triangle> create_models()
{
	...
	load_mesh("models/desk.obj", "materials/desk.mat", triangles, { { -0.2f, 0.5f, 0.9f }, rotation_matrix(3.24f, -HALF_PI) * 0.013f }, false);
	...
	load_mesh("models/simple_chair.obj", "materials/simple_chair.mat", triangles, { { 1.9f, 0.53f, 0.7f }, rotation_matrix(-2.4f) * 1.2f }, false);
	...
	load_mesh("models/dragon.obj", "materials/dragon.mat", triangles, { { -0.5f, 1.458f, 0.8f }, rotation_matrix(2.1f) * 1.3f }, false);

	load_mesh("models/glass.obj", "materials/glass.mat", triangles, { { -1.25f, 1.125f, 0.7f }, rotation_matrix(2.1f) * 0.025f }, true);

	load_mesh("models/glass.obj", "materials/glass.mat", triangles, { { 0.6f, 1.125f, 0.7f }, rotation_matrix(2.1f) * 0.025f }, true);
